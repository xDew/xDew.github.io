...
var constants = {
    ...
    toolArray: ['background~Background~fa fa-photo~backgroundDiv~Background'
                    ...
                    ,'exit~Exit~fa fa-check~moreDiv~Exit'],
